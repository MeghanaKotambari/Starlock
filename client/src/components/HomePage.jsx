...
const HomePage = () => {
  const features = [
    ...
    {
      name: "Playlist",
      icon: <ListMusic className="w-6 h-6 text-purple-600" />,
      link: "/playlist",
    },
    {
      name: "Predictions",
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-200 via-gray-100 to-purple-50 flex flex-col items-center py-20 justify-center">
      {/* Hero Section */}
      <section className="text-center mt-12 max-w-2xl">
        ...
        <p className="mt-3 text-lg text-gray-600">
          Your personal space to store, create, and explore — from notes to
          videos, from playlists to predictions
        </p>
      </section>
